...
COMMANDS=(
    ...
    '{"name":"호요랩","description":"호요랩의 유용한 기능을 이용합니다. 모든 기능을 이용하기 위해서는 쿠키 등록이 필요합니다.","options":[{"type":1,"name":"전적","description":"전적 정보를 검색합니다.","options":[{"type":3,"name":"종류","description":"조회할 전적 종류를 선택하세요.","required":true,"choices":[{"name":"일반","value":"general"},{"name":"실시간","value":"realtime"},{"name":"나선 비경","value":"spiralabyss"}]}]},{"type":1,"name":"리딤","description":"리딤코드를 입력합니다.","options":[{"type":3,"name":"값","description":"리딤코드를 입력하세요."}]},{"type":1,"name":"쿠키","description":"호요랩 쿠키를 등록/삭제합니다.","options":[{"type":3,"name":"값","description":"호요랩 로그인 쿠키를 입력하세요. 아무 것도 입력하지 않으면 등록된 쿠키를 삭제합니다."}]}]}'
    )
...
if [ $guildid != 'false' ]
then
    endpoint="https://discord.com/api/v10/applications/${appid}/guilds/${guildid}/commands"
fi
